...
AES counter model
Futhermore, AES-CTR presents symmetric and invertible/commutative operations for the encryption and decryption. Such property can be used to inverse the order of operations not to reveal the record plaintext.
