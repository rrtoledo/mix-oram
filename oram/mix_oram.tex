...
\subsection{Differentially private Oblivious Shuffle}
We could ask the mixes to process only a fraction of rounds $r \approx \frac{n}{2\cdot k }  \cdot \left( \log \left (\frac{n}{s}-0.5 \right)\right)$ to increase even more the efficiency of the eviction.
