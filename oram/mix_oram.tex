...
\noindent\textbf{Using AES-CBC.} In this scheme, the whole database is sent to a single mix, each mix permute and encrypts the whole database before sending it to the next mix as depicted in Fig~\ref{fig:ASMO_CBC}.\todo{}\\
%
\begin{figure}[H]
\begin{minipage}{0.475\textwidth}
\begin{adjustbox}{width=\textwidth}
