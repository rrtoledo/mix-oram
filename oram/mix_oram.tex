...
We present in this work different ways to delegate the eviction process to a semi-trusted mix-net proposing two mix-net architecture and two re-encryption methods.
...
\noindent\textbf{Encrypting.} We will consider in this paper two ways to re-encrypt the database, independently of the mix-net architecture. We make the assumption that all data has first been encrypted by the user before using the ORAM. \\
