...
The client thus provides to each mix session keys to access the database, the first record index $index$ of the data to shuffle and the number $k=\frac{n}{m}$ of elements allocated per mix, $ 3 $ parameters to derive encryption keys and permutation seeds and the ips and ports of all mixes participating in the eviction.  
