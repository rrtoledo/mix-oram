...
\node[draw, rectangle, align=center, label=above:{$E\left ( k_{0}'  \right )$}, label=below:{$D\left ( k_{0}  \right )$}]    		(B1)[right of=A]    { $\ $\\$\ $ };
\node[draw, rectangle, align=center, label=above:{$E\left ( k_{1}'  \right )$}, label=below:{$D\left ( k_{2}  \right )$}]    		(B2)[right of=B1]   { $\ $\\$\ $};
\node[draw, rectangle, align=center, label=above:{$E\left ( k_{2}'  \right )$}, label=below:{$D\left ( k_{2}  \right )$}]    		(B3)[right of=B2]   { $\ $\\$\ $};
\node[draw, rectangle, align=center]    		(C)[right of=B3]   {\small $E_{k1'}$\\$\Pi_{\sigma'}$};
...
\draw[decoration={brace,mirror, amplitude=1em}, decorate]  ([yshift=-1em]A.south east) -- ([yshift=-1em]C.south west) node[below, pos=0.5, yshift=-1em] {Simple E/D phase};
\path[->]
