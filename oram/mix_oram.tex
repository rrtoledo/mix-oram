...
\end{minipage}
\centering
\caption{Mix-ORAM overview.} \label{fig:rebuild}
\end{figure} 
...
To start the eviction method, the client sends to the mix-net \emph{Mix instructions} so that each mix can starts the randomization detailed in the \emph{Mix operations}. The client operations, including the modified access method, are detailed in the \emph{Client operations}.\\
